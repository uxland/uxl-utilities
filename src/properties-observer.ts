...
import { Constructor, dedupingMixin } from "./deduping-mixin";
...
export const propertiesObserver: PropertiesObserverMixinFunction =
  dedupingMixin((superClass: Constructor<any>) => {
    class PropertiesObserverMixin extends superClass {
      ...
      requestUpdate(name, oldValue) {
        let result = super.requestUpdate
